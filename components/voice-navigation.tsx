...
import { Mic, MicOff, Volume2, HelpCircle, X, Zap, MessageSquare, AlertTriangle, Settings } from "lucide-react"
      ...
      >
        <div className="flex flex-col items-center space-y-2">
          <Button
            ...
            className={`w-14 h-14 rounded-full backdrop-blur-sm transition-all duration-300 bg-gray-500 hover:bg-gray-600 text-white border-gray-400 opacity-50 cursor-not-allowed`}
            disabled
          >
            ...
            <Button
              ...
              title={
                permissionStatus === "denied"
                  ? "Microphone access denied - Click to see help"
                  : isListening
                    ? "Stop listening"
            ...
            >
              ...
              {!isSupported && (
                <Alert className="mb-6 border-red-200 bg-red-50">
                  ...
                  <AlertDescription>
                    Voice commands are not supported in this browser. Please use Chrome, Edge, or Safari for the best
                    experience.
                  </AlertDescription>
                </Alert>
              )}
              ...
              >
                ...
                <ul className={`text-sm space-y-1 ${isDark ? "text-white/70" : "text-gray-600"}`}>
                  ...
                  <li>• Speak clearly and wait for the command to process</li>
